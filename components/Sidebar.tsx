  ...
  return (
    <div className="no-print w-64 bg-gray-900 text-white flex flex-col min-h-screen">
      ...
      <div className="p-4 border-t border-gray-700">
        {authUser && (
          <div className="text-center p-3 mb-4 bg-gray-800 rounded-lg flex items-center gap-3">
        ...
        <button
            onClick={logout}
            className="w-full flex items-center justify-center p-3 rounded-md transition-colors duration-200 text-gray-300 hover:bg-red-500 hover:text-white"
            >
            <Icon name="logout" className="w-5 h-5 me-3" />
