...
const EmployeesManagement: React.FC = () => {
    const { employees, addEmployee, updateEmployee, deleteEmployee, authUser, showConfirmModal, addNotification } = useAppContext();
    ...
    const handleSave = async () => {
        ...
        if (isEditing) {
            ...
            await updateEmployee(employeeToSave as Employee);
        } else {
            await addEmployee({ ...employeeToSave, id: uuidv4() } as Employee);
        }
