...
const ReportSettings: React.FC = () => {
    const { settings, updateSettings, setPage, showConfirmModal, addNotification, customFindingCategories, predefinedFindings } = useAppContext();
    ...
    const handleSave = () => {
        updateSettings({ ...settings, reportTemplate: template });
    ...
    const handlePageSettingsChange = (newPageSettings: SettingsType['reportPageSettings']) => {
        updateSettings({ ...settings, reportPageSettings: newPageSettings });
    };
